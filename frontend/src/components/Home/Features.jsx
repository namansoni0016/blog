    ...
    return (
        <section className="py-24">
            <div className="container mx-auto px-4">
                <p className="uppercase text-blue-600 text-center text-sm font-bold font-heading mb-4">UNIQUE FEATURES</p>
                <h1 className="text-center text-4xl lg:text-5xl font-bold font-heading mb-24">Engage, Grow, and Monetize Your Passion</h1>
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Earn with Every View</h2>
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Build Your Community</h2>
                                <p className="text-gray-600">
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Intuitive Dashboard</h2>
                                <p className="text-gray-600">
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Connect with Followers</h2>
                                <p className="text-gray-600">
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Creators Leaderboard</h2>
                                <p className="text-gray-600">
                    ...
                    <div className="w-full lg:w-1/2 px-4">
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative pl-4 pb-12 border-l border-dashed border-gray-50 flex-1">
                                ...
                                <h2 className="text-2xl font-bold font-heading mb-4">Engage and Inspire</h2>
                                <p className="text-gray-600">
